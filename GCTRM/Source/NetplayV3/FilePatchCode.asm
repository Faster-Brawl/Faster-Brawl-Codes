#############################
[Project+] SD Root=/NetplayV3/
#############################
string "/NetplayV3/" @ $80406920
...
CODE @ $805A7E00
{
	...
	sth r5, 0x1A(r1)	# /
	li r5, 0x7F
	addi r3, r1, 0x1C	# String address + 10 (assumed length of "/vBrawl/" + "pf")
...
##############################################################################################################################
[Project+] RSBE v1.30 (/vBrawl/pf/sfx, can load soundbank clones for stages) (requires CSSLE) [InternetExplorer, DukeItOut]
##############################################################################################################################
* 80000000 80406920
* 80000001 805A7D18
address $805A7D18 @ $805A7D00
string[2] "/vBrawl/pf/sfx/%03X",".sawnd" @ $805A7D18
